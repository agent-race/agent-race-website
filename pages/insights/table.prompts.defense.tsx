...
const TablePromptDefense = () => {
  ...
  return (
    <Table highlightOnHover withTableBorder captionSide="bottom" withRowBorders={true}>
      <Table.Caption>Table 7: The leakage ratio (LR \%) of samples that have FuzzRate over 90, 99 or 99.9 with different attack methods.</Table.Caption>
      <Table.Thead>
...
export default TablePromptDefense;
